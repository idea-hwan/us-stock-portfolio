...
"""
가치 버킷 매도 신호 시뮬
세 축: 성장 꺾임(op/rev 감속·역성장), 고평가(P/E·P/OP·P/S·P/FCF 4년 평균 이상), 투자 압박(FCF↓·CAPEX↑)
3/6/9m SPY 초과수익 기준
"""
...
def main():
    ...
    print(f"가치 버킷: {df['ticker'].nunique()}종목  관측 {base_n:,}행")
